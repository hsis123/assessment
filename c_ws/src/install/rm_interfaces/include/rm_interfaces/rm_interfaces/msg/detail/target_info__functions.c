...
rm_interfaces__msg__TargetInfo__create()
{
  ...
  rm_interfaces__msg__TargetInfo * msg = (rm_interfaces__msg__TargetInfo *)allocator.allocate(sizeof(rm_interfaces__msg__TargetInfo), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(rm_interfaces__msg__TargetInfo));
  bool success = rm_interfaces__msg__TargetInfo__init(msg);
  if (!success) {
...
rm_interfaces__msg__TargetInfo__destroy(rm_interfaces__msg__TargetInfo * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    rm_interfaces__msg__TargetInfo__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
rm_interfaces__msg__TargetInfo__Sequence__init(rm_interfaces__msg__TargetInfo__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rm_interfaces__msg__TargetInfo * data = NULL;

  if (size) {
    data = (rm_interfaces__msg__TargetInfo *)allocator.zero_allocate(size, sizeof(rm_interfaces__msg__TargetInfo), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = rm_interfaces__msg__TargetInfo__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        rm_interfaces__msg__TargetInfo__fini(&data[i - 1]);
      }
...
rm_interfaces__msg__TargetInfo__Sequence__fini(rm_interfaces__msg__TargetInfo__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      rm_interfaces__msg__TargetInfo__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rm_interfaces__msg__TargetInfo__Sequence * array = (rm_interfaces__msg__TargetInfo__Sequence *)allocator.allocate(sizeof(rm_interfaces__msg__TargetInfo__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = rm_interfaces__msg__TargetInfo__Sequence__init(array, size);
  if (!success) {
...
rm_interfaces__msg__TargetInfo__Sequence__destroy(rm_interfaces__msg__TargetInfo__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    rm_interfaces__msg__TargetInfo__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
rm_interfaces__msg__TargetInfo__Sequence__are_equal(const rm_interfaces__msg__TargetInfo__Sequence * lhs, const rm_interfaces__msg__TargetInfo__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rm_interfaces__msg__TargetInfo__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  rm_interfaces__msg__TargetInfo__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rm_interfaces__msg__TargetInfo);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rm_interfaces__msg__TargetInfo * data =
      (rm_interfaces__msg__TargetInfo *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rm_interfaces__msg__TargetInfo__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rm_interfaces__msg__TargetInfo__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!rm_interfaces__msg__TargetInfo__copy(
