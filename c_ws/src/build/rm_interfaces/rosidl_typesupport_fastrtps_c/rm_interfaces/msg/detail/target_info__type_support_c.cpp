...
#include "rm_interfaces/msg/detail/target_info__rosidl_typesupport_fastrtps_c.h"
...
using _TargetInfo__ros_msg_type = rm_interfaces__msg__TargetInfo;
...
size_t get_serialized_size_rm_interfaces__msg__TargetInfo(
  const void * untyped_ros_message,
...
static uint32_t _TargetInfo__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rm_interfaces__msg__TargetInfo(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rm_interfaces
size_t max_serialized_size_rm_interfaces__msg__TargetInfo(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rm_interfaces__msg__TargetInfo;
    is_plain =
      (
      offsetof(DataType, z) +
      last_member_size
...
static size_t _TargetInfo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rm_interfaces__msg__TargetInfo(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rm_interfaces, msg, TargetInfo)() {
